...
- Report `expert_contract` separately from `expert_proven`. Proven expert readiness must remain false without privacy-approved anonymized real-project replay evidence and ground truth.
