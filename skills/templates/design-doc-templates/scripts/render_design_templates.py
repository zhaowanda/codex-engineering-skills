...
def empty_technical(doc_id: str, title: str) -> dict[str, Any]:
    return {
        ...
        "solution_options": [
            {"option_id": "T1", "name": "", "description": "", "pros": [], "cons": [], "risk_level": "", "validation": "", "performance_impact": "", "rollback_strategy": ""},
            {"option_id": "T2", "name": "", "description": "", "pros": [], "cons": [], "risk_level": "", "validation": "", "performance_impact": "", "rollback_strategy": ""},
        ],
        "selected_solution": {"selected_option_id": "", "selection_reason": "", "decision_criteria": [], "tradeoffs": []},
...
def empty_architecture(doc_id: str, title: str) -> dict[str, Any]:
    return {
        ...
        "architecture_options": [
            {"option_id": "A1", "name": "", "description": "", "owner_repos": [], "confirm_only_repos": [], "pros": [], "cons": [], "risk_level": "", "validation": "", "performance_impact": "", "rollback_strategy": ""},
            {"option_id": "A2", "name": "", "description": "", "owner_repos": [], "confirm_only_repos": [], "pros": [], "cons": [], "risk_level": "", "validation": "", "performance_impact": "", "rollback_strategy": ""},
        ],
        "selected_architecture": {"selected_option_id": "", "selection_reason": "", "decision_criteria": [], "tradeoffs": []},
...
def example_technical(doc_id: str, title: str) -> dict[str, Any]:
    ...
    data.update({
        ...
        "module_decomposition": [{"module": "checkout-summary", "responsibility": "render discount rows", "input": "pricing response", "output": "summary UI", "dependencies": ["pricing API"], "cohesion_reason": "presentation-only module", "coupling_control": "no pricing calculation in UI"}],
        ...
        "solution_options": [
            {"option_id": "T1", "name": "render existing API field", "description": "UI-only render", "pros": ["small change"], "cons": ["depends on existing field"], "risk_level": "low", "validation": "browser evidence", "performance_impact": "none", "rollback_strategy": "revert UI"},
            {"option_id": "T2", "name": "calculate in web", "description": "derive discounts in UI", "pros": ["independent"], "cons": ["duplicates pricing logic"], "risk_level": "high", "validation": "unit tests", "performance_impact": "minor CPU", "rollback_strategy": "revert UI"},
        ],
