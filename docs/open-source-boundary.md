...
- Gate contracts and JSON schemas.
- Design-review and code-review heuristics that do not encode private business logic.
- Documentation templates.
- Example project registry with fake names.
- Privacy scanning and validation scripts.
